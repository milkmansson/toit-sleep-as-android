...
to events that can be raised by the excellent Sleep As Android application.
...
## Benefits
Using the capabilities of Toit on a microcontroller like the ESP32 gives an incredible amount of flexibility and power:
...
- Sensor reads (light/CO₂/temp, etc) can be made through the night, or attached to specific events
...
- Using other capabilities (such as pulling weather information from the internet), heating and other environmental things can be controlled.
